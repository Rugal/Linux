...
import static rugal.common.web.Constants.POST;
import static rugal.common.web.Constants.UTF8;
...
public class RequestUtils
{
     ...
     * <code>HashTable</code> object with key-value pairs. The query string should be in the form of
     * a
     * string packaged by the GET or POST method, that is, it should have key-value pairs in the
     * form
     ...
     *
     * <p> The keys and values in the hashtable are stored in their decoded form, so any +
     * characters are
     * converted to spaces, and characters sent in hexadecimal notation (like <i>%xx</i>) are
     * converted to
     * ASCII characters.
     *
     ...
     *
     * @return a
     * <code>HashTable</code> object built from the parsed key-value pairs
     *
