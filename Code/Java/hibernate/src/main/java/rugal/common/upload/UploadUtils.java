...
import rugal.common.util.Num62;
...
public class UploadUtils
{
	...
	protected static final Pattern ILLEGAL_CURRENT_FOLDER_PATTERN = Pattern.compile(
		"^[^/]|[^/]$|/\\.{1,2}|\\\\|\\||:|\\?|\\*|\"|<|>|\\p{Cntrl}");

	/**
	 * Sanitizes a filename from certain chars.<br />
	 *
	 * This method enforces the
	 * <code>forceSingleExtension</code> property and then replaces all occurrences of \, /, |, :, ?, *,
	 ...
	 *
	 * This method replaces all occurrences of \, /, |, :, ?, *, &quot;, &lt;, &gt;, control chars by _
	 * (underscore).
	 *
	 ...
	 * @return
	 * <code>true</code> if path complies with the rules, else
	 * <code>false</code>
	 */
	 ...
	 * @return
	 * <code>true</code> if filename contains severals dots, else
	 * <code>false</code>
	 */
	...
	/**
	 * Iterates over a base name and returns the first non-existent file.<br /> This method extracts a
	 * file's base name, iterates over it until the first non-existent appearance with
